      ...
      <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-60">
        <div className="bg-slate-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
          <div className='text-slate-500 inline-flex'>
            <a className="font-medium hover:underline text-slate-50" href="#signup" rel="noreferrer">
              Sign up for Early Access
            </a> 
            {/* <span className="italic px-1.5">or</span>  */}
            {/* <a className="font-medium hover:underline text-emerald-400" href="#learn-more" rel="noreferrer">
              Learn more
            </a> */}
          </div>
